// Ported from claude-code: src/tools/WebFetchTool/preapproved.ts.
// Code-related domains the WebFetch tool can fetch and return raw markdown
// for, skipping the gpt-5.5 extraction step. Used only for GET-style fetches
// inside this tool — never as a network allowlist for other code paths.
